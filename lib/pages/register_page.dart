...
import 'package:first_auth_with_firebase/pages/login%20page.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              }, child: const Text("I already have an account",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 18),))
            ],
          ),
        ),
      ),
